		...
		mThreadHandler = new Handler(handlerThread.getLooper()) {
			...
			public void handleMessage(Message msg) {
				if (MainActivity.mDevice != null) {
					switch (msg.what) {
					case IMAGE_OPEN:
						ImageHelper.getInstance(getActivity()).openImage((String) msg.obj, MainActivity.mDevice, false);
						break;
					...
					case IMAGE_TRANSFORM:
						...
						break;
					case VIDEO_SEND:
						VideoHelper.getInstance(getActivity()).openVideo((String) msg.obj, MainActivity.mDevice, false);
						break;
					case VIDEO_STOP:
					...
					case VIDEO_SEEKBAR:
						...
						break;
					case AUDIO_SEND:
						AudioHelper.getInstance(getActivity()).openAudio((String) msg.obj, MainActivity.mDevice, false);
						break;
					case AUDIO_STOP:
