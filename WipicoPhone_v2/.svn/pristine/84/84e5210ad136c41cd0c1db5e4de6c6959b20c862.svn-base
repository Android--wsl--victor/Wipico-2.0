...
public class MediaTabActivity extends BaseTabActivity implements OnClickListener {

	private String TAG = "MediaTabActivity";
	...
	private void initView() {
		mPhoneIntent = new Intent(this, LocalMediaActivity.class);
		mDeviceIntent = new Intent(this, RemoteMediaActivity.class);
