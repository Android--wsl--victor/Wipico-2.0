...
import com.chinasvc.wipicophone.widget.ptr.PullToRefreshBase.Orientation;
...
public class FlipLoadingLayout extends LoadingLayout {
	...
	protected void onLoadingDrawableSet(Drawable imageDrawable) {
		if (null != imageDrawable) {
			...
			/**
			 * We need to set the width/height of the ImageView so
			 * that it is square with each side the size of the
			 * largest drawable dimension. This is so that it
			 * doesn't clip when rotated.
			 */
			...
			/**
			 * We now rotate the Drawable so that is at the correct
			 * rotation, and is centered.
			 */
	...
	protected void pullToRefreshImpl() {
		// Only start reset Animation, we've previously show the rotate
		// anim
