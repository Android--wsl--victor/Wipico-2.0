...
import com.chinasvc.wipicophone.widget.ptr.PullToRefreshBase.Mode;
import com.chinasvc.wipicophone.widget.ptr.PullToRefreshBase.OnPullEventListener;
import com.chinasvc.wipicophone.widget.ptr.PullToRefreshBase.OnRefreshListener;
import com.chinasvc.wipicophone.widget.ptr.PullToRefreshBase.OnRefreshListener2;
import com.chinasvc.wipicophone.widget.ptr.PullToRefreshBase.State;
...
public interface IPullToRefresh<T extends View> {
	 ...
	 * aware it is there. This could be useful when the user first opens
	 * your app, etc. The animation will only happen if the Refresh View
	 * (ListView, ScrollView, etc) is in a state where a Pull-to-Refresh
	 * could occur by a user's touch gesture (i.e. scrolled to the
	 * top/bottom).
	 * 
	...
	/**
	 * Get the mode that this view is currently in. This is only really
	 * useful when using <code>Mode.BOTH</code>.
	 * 
	 ...
	 * returned, then the View will only use touch events where the
	 * difference in the Y-axis is greater than the difference in the
	 * X-axis. This means that the View will not interfere when it is used
	 * in a horizontal scrolling View (such as a ViewPager).
	 * 
	 ...
	 * need it.
	 * 
	 * @return Object which will proxy any calls you make on it, to all of
	 *         the LoadingLayouts.
	 */
	 ...
	 * will not interfere when it is used in a horizontal scrolling View
	 * (such as a ViewPager), but will restrict which types of finger
	 * scrolls will trigger the View.
	 * 
	 * @param filterEvents
	 *                - true if you want to filter Touch Events. Default is
	 *                true.
	 */
	 ...
	 * 
	 * @param listener
	 *                - Listener to be used when the Widget has a pull event
	 *                to propogate.
	 */
	 ...
	 * 
	 * @param listener
	 *                - Listener to be used when the Widget is set to
	 *                Refresh
	 */
	 ...
	 * only takes effect when running on device with Android v2.3 or
	 * greater.
	 * 
	 * @param enabled
	...
	/**
	 * By default the Widget disables scrolling on the Refreshable View
	 * while refreshing. This method can change this behaviour.
	 * 
	 * @param scrollingWhileRefreshingEnabled
	 *                - true if you want to enable scrolling while
	 *                refreshing
	 */
